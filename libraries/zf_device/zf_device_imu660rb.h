...
#define IMU660RB_SCL_PIN            (P15_2)                                     // 软件 IIC SCL 引脚 连接 IMU660RB 的 SCL 引脚
#define IMU660RB_SDA_PIN            (P15_1)                                     // 软件 IIC SDA 引脚 连接 IMU660RB 的 SDA 引脚
//====================================================软件 IIC 驱动====================================================
#else
...
#define IMU660RB_SPC_PIN            (SPI2_CLK_P15_2  )                          // 硬件 SPI SCK 引脚
#define IMU660RB_SDI_PIN            (SPI2_MOSI_P15_1 )                          // 硬件 SPI MOSI 引脚
#define IMU660RB_SDO_PIN            (SPI2_MISO_P15_0 )                          // 硬件 SPI MISO 引脚
//====================================================硬件 SPI 驱动====================================================
#endif
#define IMU660RB_CS_PIN             (P15_3)                                       // CS 片选引脚
