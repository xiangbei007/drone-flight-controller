...
// 引脚配置
//--------------------------------------------------------------------------------------------------
#define MT9V03X_COF_IIC_DELAY   ( 400   )                                       // 总钻风 IIC 延时
#define MT9V03X_COF_IIC_SCL     ( P17_1 )                                       // 总钻风 IIC-SCL 引脚
#define MT9V03X_COF_IIC_SDA     ( P17_2 )                                       // 总钻风 IIC-SDA 引脚

#define MT9V03X_PCLK_PIN        ( P06_5 )                                       // 总钻风 PCLK 触发信号引脚
#define MT9V03X_VSYNC_PIN       ( P06_6 )                                       // 总钻风 场中断  引脚

#define MT9V03X_DATA_PIN        ( P18_0 )                                       // 总钻风 数据    引脚 这里是 P18_0 ~ P18_7
//--------------------------------------------------------------------------------------------------
// 引脚配置
//--------------------------------------------------------------------------------------------------
...
// 摄像头默认参数配置 在此修改摄像头配置
//--------------------------------------------------------------------------------------------------
#define MT9V03X_W               ( 188 )                                         // 图像宽度     (可修改 不得超过188)  当分辨率为188 * 120时，可采集到至多110帧的完整图片
#define MT9V03X_H               ( 120 )                                         // 图像高度     (可修改 不得超过120)  当分辨率为 94 * 60 时，可采集到至多259帧的完整图片(其他分辨率为裁剪图片)      
