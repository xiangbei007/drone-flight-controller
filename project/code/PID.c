...
PIDControllerType_t RollPID = {
	...
	.ki = 0.005f,  // 增大到0.005，消除静差（从0.001增大）
	.kd = 0.3f,
	...
	.IntegralThreshold = 5.0f,    // 降低到5度，更积极积分（从10降低）
	.alpha = 0.9f,
	.prev_error = 0,
	.intergral = 0,
	.derivative = 0,
...
PIDControllerType_t RollRatePID = {
	...
	.ki = 0.02f,
	.kd = 0.0f,
	.LimitIntegralMax = 2000.0f,  // 降低积分限幅（从4000降到2000）
	.LimitIntegralMin = -2000.0f,
	.LimitOutputMax = 2000.0f,    // 降低输出限幅，防止饱和（从4000降到2000）
	.LimitOutputMin = -2000.0f,
...
PIDControllerType_t PitchPID = {
	...
	.LimitOutputMax = 150.0f,      // 角速度限幅,限制 ~100度/s (约1.745 rad/s) 更稳定
	.LimitOutputMin = -150.0f,
	.IntegralThreshold = 5.0f,    // 降低到5度（从10降低）
	.alpha = 0.9f,
	.prev_error = 0,
	.intergral = 0,
	.derivative = 0,
...
PIDControllerType_t PitchRatePID = {
	...
	.LimitIntegralMax = 2000.0f,  // 降低积分限幅（从4000降到2000）
	.LimitIntegralMin = -2000.0f,
	.LimitOutputMax = 2000.0f,    // 降低输出限幅（从4000降到2000）
	.LimitOutputMin = -2000.0f,
	.IntegralThreshold = 20.0f ,  // 20度/s开始积分
	.alpha = 0.8f,
	.prev_error = 0,
